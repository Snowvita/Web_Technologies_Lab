...
public class res_h2 extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            out.println("h2 { color: #472d00; font-size: 28px; margin: 20px 0; }"); // Color for h2
            out.println("h3 { color: #472d00; font-size: 24px; margin: 20px 0; }"); // New color for h3
            out.println("p { font-size: 16px; color: #000000; margin: 20px 0; }");
            out.println("</style>");
            out.println("</head>");
            out.println("<body>");
